...
int arch_cpu_init(struct per_cpu *cpu_data)
{
     ...
     * ===NOTE===
     * control registers:
     * CR0: operating-mode controls, some processor-feature controls
     ...
     * CR2: page translation. page fault virtual addr
     * CR3: base addr of the highest level page-translation table, cache control
     * CR4: additional controls for various operating-mode features such as virtual-8086 support, enabling I/O breakpoints, page size extension and machine-check exceptions.
     * CR8: use REX prefix, prioritize external interrupts and referred to as TPR(task priority)
     * RFLAGS: processor-status and processor-control fields
     */
    ...
    /*
     * msr: model-specific table
     * used for debugging, program execution tracing, computer performance monitoring
     * mtrr: memory type range register, 用于控制处理器对内存范围的访问
